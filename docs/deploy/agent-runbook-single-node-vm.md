...
The hub's default GCP identity does not apply the VM service account to
agents on the hybrid tier's GKE profile. Configure a project-level GCP
identity mode for projects that dispatch to it.
