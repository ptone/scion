...
func (_q *ConversationParticipantQuery) ForUpdate(opts ...sql.LockOption) *ConversationParticipantQuery {
...
func (_q *ConversationParticipantQuery) ForShare(opts ...sql.LockOption) *ConversationParticipantQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
