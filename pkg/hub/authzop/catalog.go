...
var MutationClassifications = []MutationClassification{
	...
	{File: "pkg/hub/seed.go", Function: "CleanupRedundantHubMemberBindings", Symbol: "DeleteRoleBinding", Exemption: &MutationExemption{Kind: ExemptionInternalOnly, Reason: "Server startup: remove redundant system-created direct hub-member bindings for users with canonical group membership", Scope: "pkg/hub/seed.go"}},
