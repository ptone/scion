...
var MutationClassifications = []MutationClassification{
	...
	{File: "pkg/hub/handlers_users_core.go", Function: "deleteSuperAdminBindingTx", Symbol: "DeleteRoleBinding", Exemption: &MutationExemption{Kind: ExemptionInternalOnly, Reason: "Super-admin binding deletion inside single atomic WithTx in updateUser; caller checks user.promote + CanDelegate; guarded by checkLastSuperAdminTx", Scope: "pkg/hub/handlers_users_core.go"}},
