...
// Activity represents what an agent is doing. Most activities are only
// meaningful when Phase == PhaseRunning, but terminal activities (crashed,
// limits_exceeded) are valid when Phase == PhaseStopped — they carry
// information about HOW the agent stopped.
