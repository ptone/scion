...
# passthrough is honoured only on the hub's own embedded broker. Change to
# \"block\" or \"assign\" via the admin UI or the server-config API; see
# docs/deploy/agent-runbook-single-node-vm.md §6.3b.
