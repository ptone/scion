...
# guards were unreachable the first time it ran, which is what put GO_BIN and the
# single-stage case in the file. Re-run it after adding or moving a rule; a guard
# with no case is a comment, and a case no guard owns is decoration.
#
