...
Output goes to stdout (-> Cloud Logging). Uses flush=True.

Includes an HTTP health check server on port 8080 to satisfy
the Cloud Run startup probe.
"""
...
# ===================================================================
# Health check server (startup probe)
# Skip if already bound (e.g. when launched via bootstrap)
# ===================================================================
...
log(f"Health check server running on :8080")
...
log(f"Creating sandbox {sid1} with sleep 3600...")
