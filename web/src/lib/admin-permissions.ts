...
export const NAV_PERMISSION_MAP: Record<string, string[]> = {
  ...
  '/admin/access-boundaries': ['access_boundary.read', 'access_boundary.admin'],
...
export const ROUTE_PERMISSION_MAP: Record<string, string[]> = {
  ...
  'scion-page-admin-access-boundaries': ['access_boundary.read', 'access_boundary.admin'],
  'scion-page-admin-access-boundary-detail': ['access_boundary.read', 'access_boundary.admin'],
  'scion-page-admin-access-boundary-editor': ['access_boundary.admin'],
